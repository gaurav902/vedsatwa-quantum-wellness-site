  ...
  return (
    <footer className="relative py-16 px-4 bg-transparent overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
        {/* Glass info */}
        <div className="glass bg-white/30 backdrop-blur-3xl border border-white/20 rounded-2xl shadow-lg space-y-8 p-8">
        ...
        {/* Glass map */}
        <div className="glass h-72 shadow-lg border border-white/20 rounded-2xl overflow-hidden backdrop-blur-3xl bg-white/30 relative">
      ...
      <div className="mt-16 pt-8 border-t border-white/20 text-center glass bg-white/30 backdrop-blur-3xl rounded-xl shadow-sm px-4">
