...
export function HeroSection() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-ayurveda-forest/10 to-[#f6d4d2]/10 pt-2">
      <div className="absolute inset-0 -z-10">
        {/* Subtle cloud/fog overlays */}
        <div className="absolute top-0 right-0 w-40 h-40 bg-ayurveda-saffron/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-60 h-60 bg-ayurveda-forest/10 rounded-full blur-3xl" />
        {/* Extra cloudy/foggy effect */}
        <div className="absolute left-20 bottom-10 w-56 h-36 bg-[#fff] opacity-20 rounded-full blur-2xl" />
        <div className="absolute right-10 top-16 w-40 h-16 bg-[#aaa] opacity-10 rounded-full blur-3xl" />
      </div>
